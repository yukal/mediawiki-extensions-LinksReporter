 ...
 * @ingroup Pager
 */
class LinksReporterPager extends ReverseChronologicalPager {
    ...
    function getQueryInfo() {
        ...
        $timestamp = abs( intval( $this->opts->getValue( 'timestamp' ) ) );
        if ( $this->opts->getValue( 'timestamp-mode' ) === 'max' ) {
            $conds[] = 'rc_timestamp > ' . $timestamp;
        } else {
            $conds[] = 'rc_timestamp < ' . $timestamp;
        }
    ...
    protected function getStartBody() {
        ...
        return '<div class="linksreporter-rows">';
    }
